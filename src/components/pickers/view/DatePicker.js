...
class DatePicker extends BaseDialog {
  ...
  getDateList() {
    ...
    let selectedIndex = [
      ...
      days.indexOf(selectedDay + unit[2]) == -1
        ? days.length - 1
        : days.indexOf(selectedDay + unit[2]),
    ];
      ...
      if (this.props.selectedValue) {
        selectedIndex.push(
          (this.props.selectedValue[3]
            ? parseInt(this.props.selectedValue[3])
            : new Date().getHours()) - 1,
        );
      } else {
        ...
        if (this.props.selectedValue) {
          selectedIndex.push(
            (this.props.selectedValue[4]
              ? parseInt(this.props.selectedValue[4])
          ...
          if (this.props.selectedValue) {
            selectedIndex.push(
              (this.props.selectedValue[5]
                ? parseInt(this.props.selectedValue[5])
                : 1) - 1,
            );
          } else {
