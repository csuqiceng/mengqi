    ...
    return this.props.items.map((item, index) => {
      return (
        <TouchableOpacity
          ...
          style={{
            paddingLeft: this.getSize(20),
            paddingRight: this.getSize(20),
          ...
          <View
            style={{
              ...
              borderRadius: this.props.pointBorderRadius,
              borderWidth: 1,
              borderColor:
                this.state.seleted == index
            ...
            {this.state.seleted == index ? (
              <View
                style={{
                  width: this.props.pointSize * 0.6,
                  height: this.props.pointSize * 0.6,
          ...
          onPress={() => {
            this.dismiss(() => {
              if (this.props.onPress) {
                this.props.onPress(
                  this.state.seleted != null ? this.state.seleted : -1,
                );
              }
            });
          }}
          style={{
            width: this.getSize(200),
