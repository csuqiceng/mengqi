      ...
      <Animated.View
        ...
        <View
          style={{
            ...
            alignItems: 'center',
            marginTop: this.getSize(25),
          }}>
          <View
            style={{
              width: this.getSize(280),
              height: 4,
              borderRadius: 2,
          ...
          <Animated.View
            style={{
              ...
              position: 'absolute',
              left: this.getSize((307 - 280) / 2),
            }}
          />
        </View>
        <Text
          style={{
            paddingRight: this.getSize(12),
            textAlign: 'right',
            width: this.getSize(307),
            marginTop: this.getSize(5),
            marginBottom: this.getSize(15),
            color: this.props.totalTextColor,
            height: this.props.totalTextSize,
            fontSize: this.props.totalTextSize,
            lineHeight: this.props.totalTextSize,
          }}>
          {this.state.total}
        </Text>
        <View
