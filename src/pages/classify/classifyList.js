      ...
      return (
        <View style={{ flexDirection: 'column' }}>
          ...
          {goodsDataList.map((item, i) => {
            return (
              <View key={i} style={{flexDirection:'row',flex:1,marginTop:5}}>
                {
                  item.map((item, i) => {
                    return (
                      <TouchableHighlight
  ...
  render() {
      return (
        <View>
          ...
          />
          <View style={{height:40,backgroundColor:'white',justifyContent:'space-around',flexDirection:'row',alignItems:'center'}}>
            <TouchableOpacity
              activeOpacity={0.5}
              onPress={() => {
                this.setState({selectbutton:'zonghe'})
              }}>
              <Text style={{color:this.state.selectbutton =='zonghe'?'#007B73':'black',fontSize: 15}}>综合</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.5}
              onPress={() => {
              ...
              <Text style={{color:this.state.selectbutton =='xiaoliang'?'#007B73':'black',fontSize: 15}}>销量</Text>
            </TouchableOpacity>

              <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                <Text style={{color:this.state.selectbutton =='jiage'?'#007B73':'black',fontSize: 15}} >价格</Text>
                <View>
                  <TouchableOpacity
                    activeOpacity={0.5}
                    onPress={() => {
                    ...
                    <Image
                      source={this.state.selecticon === 'up' && this.state.selectbutton === 'jiage' ?require('../../assets/images/up_hover.png'):require('../../assets/images/up.png')}
                  ...
                  <TouchableOpacity
                    ...
                    <Image
                      source={this.state.selecticon === 'down' && this.state.selectbutton === 'jiage' ? require('../../assets/images/down_hover.png'):require('../../assets/images/down.png')}
                      style={{width: 17, height: 12, marginLeft: 6}}
                    />
                  </TouchableOpacity>
                </View>
