...
//每个索引的高度
const sectionItemHeight =
  (height - statusHeight - sectionTopBottomHeight * 2 - headerHeight) / 25;
...
class CitySelect extends Component {
  ...
  scrollSectionList(event) {
    ...
    if (
      touch.pageY >= sectionTopBottomHeight + headerHeight + statusHeight &&
      touch.pageY <=
        statusHeight +
          headerHeight +
          sectionTopBottomHeight +
          sectionItemHeight * 25 &&
  ...
  sectionItemView() {
      ...
      return (
        <Text
          ...
          style={[
            ...
            {
              backgroundColor: this.state.isTouchDown
                ? touchDownBGColor
                : touchUpBGColor,
            },
          ]}>
    ...
    return (
      <ScrollView
        style={cityStyle.sectionItemViewStyle}
        ref="sectionItemView"
