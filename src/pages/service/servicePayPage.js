        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View>
            ...
            <View
              ...
              <View style={{flex: 1}} />
              <Text>
                {orderData.orderInfo ? orderData.orderInfo.orderSn : ''}
              </Text>
            </View>
            <View
              style={{
              ...
              <Text style={{color: 'red'}}>
                ¥ {orderData.orderInfo ? orderData.orderInfo.actualPrice : ''}
              </Text>
            </View>
          </View>
          <View style={{backgroundColor: 'white', marginTop: 20}}>
            ...
            <View>
              <View
                ...
                <Image
                  resizeMode={'contain'}
                  source={require('../../assets/images/ali_pay.png')}
              ...
              <View
                ...
                <Image
                  resizeMode={'contain'}
                  source={require('../../assets/images/wx_pay.png')}
                  style={{width: 120, height: 30, marginLeft: 5}}
                />
                <View style={{flex: 1}} />
                <CheckBox
                  style={{width: 30}}
