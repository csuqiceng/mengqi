    ...
    return(
        <View style={styles.topViewStyle}>
            ...
            <View style={styles.centerViewStyle}>
                <Text style={{fontSize:18, color:'white', fontWeight:'bold',marginLeft: 10}}>{info.userId}</Text>
...
function renderBottomItem(info) {
    ...
    var itemArr = [];
    // 数据数组
    var data = [{'number':info.amount, 'title':'我的余额'},{'number':'321', 'title':'积分'},{'number':'12', 'title':'优惠券'}];
    // 遍历创建组件装入数组
