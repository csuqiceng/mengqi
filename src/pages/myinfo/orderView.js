    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                />
                    <View style={{flexDirection:'row',height: 40,backgroundColor:'white',marginBottom: 10}}>
                        {
        ...
        if (AllorderData.length > 0 ){
                ...
                <View style={{flex: 1}}>
                    {
                        AllorderData.map((item, i) => {
                            return (
                                <TouchableOpacity key={item.id} activeOpacity={0.5} onPress={()=>{alert('详情')}}>
                                    <View style={{margin:10,height: 200,borderColor:'gray',borderWidth:1,backgroundColor:'white',borderRadius:5}}>
                                        <View style={{flexDirection:'row',height: 50,justifyContent:'space-between',alignItems: 'center',marginRight:15,marginLeft:15}}>
                                             <Text>订单号：{item.orderSn}</Text>
                                             <Text style={{color:'#00655D',fontWeight:'bold'}}>{item.orderStatusText}</Text>
                                        </View>
                                        <View style={{flex: 1,flexDirection:'row',borderTopColor:'#F1F1F1',borderTopWidth:1,borderBottomColor: '#F1F1F1',borderBottomWidth: 1,marginLeft:15,marginRight:15}}>
                                            <Image resizeMode={'cover'} source={{uri: item.goodsList[0].picUrl}}  style={{width:120 , height:80,marginTop:10}} />
                                            <View style={{margin:10}}>
                                                <Text >{item.goodsList[0].goodsName}</Text>
                                                <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:10}}>
                                                    <Text >数量：{item.goodsList[0].number}</Text>
                                                    <Text style={{color:'#FA5700',fontWeight:'bold'}}>¥ {item.actualPrice}</Text>
                                                </View>
                                            </View>
                                        </View>
            ...
            return (
                <View style={{justifyContent:'center',alignItems: 'center',flex: 1}}>
                    <Image source={require('../../assets/images/myinfo/payment_none.png')} style={{
                        width:120,
                        height:90,
                    }}/>
                    <Text>没有订单</Text>
