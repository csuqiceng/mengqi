...
export default class MyNewAddressView extends React.Component {
    ...
    renderTitleItem = () => {
        return (
            <Text style={{ textAlign: 'center', justifyContent: 'center', fontSize: 20,marginLeft: -20 }}>添加新收货人</Text>
        );
    }
                 ...
                 <View style={{flex:1 }}>
                    ...
                    />
                     ...
                     <View style={{ flex: 1,backgroundColor: '#F1F1F1' }}>
                        <View style={{height:60,backgroundColor:'white',flexDirection:'row',alignItems: 'center',marginTop:10,paddingLeft:15}}>
                                <Text style={{fontSize: 15,width:100}}>姓名</Text>
                                <TextInput
                                    value={this.state.name}
                                    underlineColorAndroid='transparent'
                                    placeholder={' 请输入收货人姓名'}
                                    onChangeText={(name)=>{this.setState({name})}}  //添加值改变事件
                        ...
                        <View style={{height:60,backgroundColor:'white',marginTop:10,flexDirection:'row',alignItems: 'center',paddingLeft:15}}>
                            ...
                            <TextInput
                                ...
                                underlineColorAndroid='transparent'
                                placeholder={' 请输入手机号码'}
                                onChangeText={(tel)=>{this.setState({tel})}}  //添加值改变事件
                                style={{ ...styles.tgTextInputStyle}}
                            />
                        </View>
                        <View style={{height:60,backgroundColor:'white',marginTop:10,flexDirection:'row',alignItems: 'center',paddingLeft:15}}>
                            ...
                            <TextInput
                                ...
                                onChangeText={(areaCode)=>{this.setState({areaCode})}} //添加值改变事件
                                style={{ ...styles.tgTextInputStyle}}
                            />
                        </View>
                        <View style={{height:60,backgroundColor:'white',marginTop:10,flexDirection:'row',alignItems: 'center',paddingLeft:15}}>
                        ...
                        <View style={{height:60,backgroundColor:'white',marginTop:10,flexDirection:'row',alignItems: 'center',paddingLeft:15}}>
                            ...
                            <TextInput
                                ...
                                onChangeText={(addressDetail)=>{this.setState({addressDetail})}}  //添加值改变事件
                                style={{ ...styles.tgTextInputStyle}}
                            />
                        </View>
                        <View style={{flexDirection:'row',marginTop:10,marginLeft:10,alignItems: 'center'}}>
                            <CheckBox
                                style={{width:20}}
                                onClick={()=>{this.setState({isDefault:!this.state.isDefault})}}
                     ...
                     <TouchableOpacity activeOpacity={0.5} onPress={() => {this.addNewAddress()}}>
                        <View style={styles.tgLoginBtnStyle}>
                            <Text style={{ color: 'black', textAlign: 'center', justifyContent: 'center',fontSize: 16 }}>{"确认"}</Text>
                        </View>
                    </TouchableOpacity>
