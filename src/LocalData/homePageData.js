...
const mainServerData = [
  {
    ...
    pid: 0,
    iconUrl:
      'http://lhh.natapp1.cc/api/wx/storage/fetch/nqvkkmlarpowibjhcnml.png',
    picUrl: '',
    level: 'L1',
    sortOrder: 50,
    addTime: '2021-07-28 14:00:47',
    updateTime: '2021-07-29 09:08:25',
    deleted: false,
    goodsType: '02',
  },
  {
    ...
    pid: 0,
    iconUrl:
      'http://lhh.natapp1.cc/api/wx/storage/fetch/e9xcfrjp6jmnfttj658w.png',
    picUrl: '',
    level: 'L1',
    sortOrder: 50,
    addTime: '2021-07-29 09:09:42',
    updateTime: '2021-07-29 09:09:42',
    deleted: false,
    goodsType: '02',
  },
  {
    ...
    pid: 0,
    iconUrl:
      'http://lhh.natapp1.cc/api/wx/storage/fetch/kx4yt83sao4e4x3qr769.png',
    picUrl: '',
    level: 'L1',
    sortOrder: 50,
    addTime: '2021-07-29 09:10:55',
    updateTime: '2021-07-29 09:10:55',
    deleted: false,
    goodsType: '02',
  },
  {
    ...
    pid: 0,
    iconUrl:
      'http://lhh.natapp1.cc/api/wx/storage/fetch/y5dhni9jeur41ndkfb73.png',
    picUrl: '',
    level: 'L1',
    sortOrder: 50,
    addTime: '2021-07-29 09:13:08',
    updateTime: '2021-07-29 09:13:08',
    deleted: false,
    goodsType: '02',
  },
  {
    ...
    pid: 0,
    iconUrl:
      'http://lhh.natapp1.cc/api/wx/storage/fetch/nwnaw6gerc6dudvtijcn.png',
    picUrl: '',
    level: 'L1',
    sortOrder: 50,
    addTime: '2021-07-29 09:13:39',
    updateTime: '2021-07-29 09:13:39',
    deleted: false,
    goodsType: '02',
  },
];
...
const hotServerData = [
  {
    ...
    brief: '日常保洁',
    picUrl:
      'http://lhh.natapp1.cc/api/wx/storage/fetch/85hsxdb1w19z0u2hy7zh.png',
    isNew: true,
    isHot: true,
    counterPrice: 200,
    retailPrice: 150,
  },
  {
    ...
    brief: '家政保洁日常保洁服务上门..',
    picUrl:
      'http://lhh.natapp1.cc/api/wx/storage/fetch/nph3plm5mfxk9jn0aw9x.png',
    isNew: true,
    isHot: true,
    counterPrice: 198,
    retailPrice: 88,
  },
  {
    ...
    brief: '清洗服务洗衣机清洗',
    picUrl:
      'http://lhh.natapp1.cc/api/wx/storage/fetch/19aw8og3l9grtif3ytdj.png',
    isNew: true,
    isHot: true,
    counterPrice: 160,
    retailPrice: 0,
  },
  {
    ...
    brief: '',
    picUrl:
      'http://lhh.natapp1.cc/api/wx/storage/fetch/299c4ctqxnr9smx9zbev.png',
    isNew: true,
    isHot: true,
    counterPrice: 300,
    retailPrice: 0,
...
const preferentialData = [
  {
    ...
    brief: '',
    picUrl:
      'http://lhh.natapp1.cc/api/wx/storage/fetch/6v5i8igbrmr8hi6ag9gm.png',
    isNew: true,
    isHot: true,
    counterPrice: 69.8,
    retailPrice: 39.8,
  ...
  },
  {
    ...
    brief: '',
    picUrl:
      'http://lhh.natapp1.cc/api/wx/storage/fetch/es5f76k29mjbid0q30gj.png',
    isNew: true,
    isHot: true,
    counterPrice: 0,
    retailPrice: 0,
  },
  {
    ...
    brief: '',
    picUrl:
      'http://lhh.natapp1.cc/api/wx/storage/fetch/6k6oamekoyubqm1xj59u.png',
    isNew: true,
    isHot: true,
    counterPrice: 0,
    retailPrice: 0,
